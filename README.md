...
在眾多機器學習算法中，選擇 XGBoost（eXtreme Gradient Boosting）作為預測模型的核心，主要基於以下幾個理由：
...
### 特徵增強的需求
儘管進行了多種數據平衡技術的試驗，我們認為模型的準確度仍有提升空間。未來，如果能從原始數據中提取或添加更多與客戶流失直接相關的特徵，將可能顯著提高預測的準確性。期望透過進一步的數據探索和特徵工程，來發現新的有價值的預測信號。
